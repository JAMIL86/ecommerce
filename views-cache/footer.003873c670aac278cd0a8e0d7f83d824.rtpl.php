...
<!-- jQuery sticky menu -->
<script src="<?php echo BASE_URL; ?>res/site/js/owl.carousel.min.js"></script>
<script src="<?php echo BASE_URL; ?>res/site/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="<?php echo BASE_URL; ?>res/site/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="<?php echo BASE_URL; ?>res/site/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="<?php echo BASE_URL; ?>res/site/js/bxslider.min.js"></script>
<script type="text/javascript" src="<?php echo BASE_URL; ?>res/site/js/script.slider.js"></script>
</body>
</html>